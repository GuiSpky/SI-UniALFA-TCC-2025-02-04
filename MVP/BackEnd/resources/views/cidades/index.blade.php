    ...
    <div class="mb-4 fade-in-up">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                ...
                <p class="text-muted mb-0">Gerencie todas as cidades do sistema</p>
            </div>
            <a href="{{ route('cidades.create') }}" class="btn btn-primary btn-lg" style="background: linear-gradient(135deg, #0d6efd 0%, #0dcaf0 100%); border: none; transition: all 0.3s ease;">
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0" style="color: #ffffff;">
                <thead style="background-color: #1a1a2e; border-bottom: 2px solid #2a2a3e;">
                    <tr>
                        <th style="color: #b0b0b0; font-weight: 600; padding: 1rem;">Cod. IBGE</th>
                        <th style="color: #b0b0b0; font-weight: 600; padding: 1rem;">Nome</th>
                        <th style="color: #b0b0b0; font-weight: 600; padding: 1rem;">UF</th>
                ...
                <tbody>
                    @forelse ($cidades as $cidade)
                        <tr style="border-bottom: 1px solid #2a2a3e; transition: all 0.3s ease;">
                            ...
                            <td style="padding: 1rem;">
                                <a href="{{route('cidade.show', $cidade)}}" style="color: #0dcaf0; text-decoration: none; transition: all 0.3s ease; font-weight: 500;">
                                    {{ $cidade->nome }}
                                </a>
                            </td>
                            <td style="padding: 1rem;">
                            ...
                            <td style="padding: 1rem; text-align: center;">
                                <div class="btn-group" role="group">
                                    <a href="{{route('cidades.edit', $cidade->id)}}" class="btn btn-sm" style="background-color: #1a5f7a; color: #0dcaf0; border: 1px solid #0dcaf0; transition: all 0.3s ease; border-radius: 6px; margin-right: 0.5rem;" title="Editar">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <form action="{{route('cidades.destroy', $cidade)}}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-sm" style="background-color: #7a1a1a; color: #ff6b6b; border: 1px solid #ff6b6b; transition: all 0.3s ease; border-radius: 6px;" type="submit" onclick="return confirm('Deseja realmente apagar esta cidade?')" title="Apagar">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center py-5">
                                ...
                                <p style="color: #b0b0b0; margin-top: 1rem;">Nenhuma cidade encontrada</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
